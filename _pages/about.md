        ...
        <tr>
            <td>
                <div class="image-container">
                    <img class="portfolio-image" src="./images/evaporation_driven_buckling_sch3.png" alt="Evaporation driven buckling of colloidal drops" align="center" style="margin-right: 0px; width: auto; height: 200px">
                    <div class="description">Evaporation driven buckling of colloidal drops.</div>
                </div>
            </td>
            <td>
                <div class="image-container">
                    <img class="portfolio-image" src="./images/monolayer_buck.png" alt="Buckling of monolayer of plate like particles" align="center" style="margin-right: 0px; height: 200px; width: auto;">
                    <div class="description">Buckling of monolayer of plate like particles.</div>
                </div>
            </td>
          <td>
                <div class="image-container">
                    <img class="portfolio-image" src="./images/spiral_jet.png" alt="Controlling the breakup of spiralling liquid jets" align="center" style="margin-right: 0px; height: 200px; width: auto;">
